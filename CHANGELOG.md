...
- Fix segment detection at negative time intervals by considering the absolute time difference ([#140](https://github.com/xdf-modules/pyxdf/pull/140) by [Benedikt Ehinger](https://github.com/behinger))
